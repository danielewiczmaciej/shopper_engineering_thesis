...
\begin{lstlisting}[language=JavaScript, caption=Strona tytułowa implementacja, label=lst:view]
...
\begin{lstlisting}[language=JavaScript, caption=Ekran logowania implementacja, label=lst:view]
...
\begin{lstlisting}[language=JavaScript, caption=Ekran rejestracji implementacja, label=lst:view]
...
\begin{lstlisting}[language=JavaScript, caption=Ekran kategorii implementacja, label=lst:view]
...
\begin{lstlisting}[language=JavaScript, caption=Ekran produktów implementacja, label=lst:view]
...
\begin{lstlisting}[language=JavaScript, caption=Generowanie kodu QR implementacja, label=lst:view]
...
\begin{lstlisting}[language=JavaScript, caption=Mapa sklepów implementacja, label=lst:view]
...
\begin{lstlisting}[language=JavaScript, caption=Koszyk użytkownika implementacja, label=lst:view]
...
\begin{lstlisting}[language=JavaScript, caption=Nawigacja użytkownika implementacja, label=lst:view]
...
\begin{lstlisting}[language=JavaScript, caption=Profil użytkownika implementacja, label=lst:view]  
